...
- **`main` = HARAM disentuh anak magang.** Branch ini terproteksi; push langsung
...
- Rilis ke prod adalah urusan Direktur. Tim magang **berhenti di `dev`**.

---

## 2. Domain TERLARANG (jangan dikerjakan)

Tim magang **tidak boleh** membuat/mengubah fitur di 4 domain ini. Kalau tugas
...
Daftar fitur yang **boleh** dikerjakan magang ada di **[`docs/MAGANG-FEATURES.md`](./docs/MAGANG-FEATURES.md)**
...
Fitur di luar `MAGANG-FEATURES.md` (CRM/HR/Management/Infra/Finance/ERP) bukan untukmu.
Belum jelas F-number-mu? Tanya Direktur.

> Sinkronisasi: file itu di-generate `scripts/ops/gen-magang-features.py` dari board —
...
4. Tim magang **tidak** mengurus deploy/apply prod sama sekali.
...
- `docs/AUTO-DEPLOY.md` — cara prod di-deploy (referensi; bukan tugas magang)
