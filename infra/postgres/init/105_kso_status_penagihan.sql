-- 105 — pisahkan dua keadaan yang selama ini tercampur di `bulan_tertagih_accurate = 0`.
--
-- MASALAHNYA: nilai 0 dipakai untuk dua hal yang sangat berbeda, dan menyesatkan kalau
-- dibaca apa adanya. Pada data prod 2026-08-18:
--
--                              ada catatan tes | faktur tanpa catatan | tanpa faktur
--     BELI_REAGEN                          26  |                  94  |          23
--     PER_TEST                             69  |                   2  |           2
--
-- 94 faskes BELI_REAGEN ditagih normal dan memang TIDAK punya baris PEMERIKSAAN — skema
-- beli-reagen tidak ditagih per tes. Mencampurnya dengan faskes yang benar-benar nol
-- faktur membuat anomali sungguhan tenggelam di antara 94 kasus normal.
--
-- Yang sungguhan, dan sekarang bisa disaring dengan satu klausa:
--     PER_TEST + 'tanpa_faktur'             -> TEJA HUSADA (370 tes 2026), HAJI RSIA Batu
--                                              (435 tes). Alat aktif, nol faktur atas nama
--                                              mereka, tidak ada customer lain yang ditagih
--                                              untuk alatnya.
--     PER_TEST + 'faktur_tanpa_catatan_tes' -> MARISA, SYMPONI. Ditagih normal lewat baris
--                                              reagen berkategori KSO, cuma tanpa baris
--                                              pencatat tesnya.
--
-- KENAPA PEMBEDAAN INI BUKAN AKADEMIS: WIDODO sempat tampak 'tanpa_faktur' dengan 113.646
-- tes, dan ternyata ditagih lewat WIDODO INTAN NUSA, PT — badan hukum yang namanya tidak
-- menyerupai nama faskes sama sekali. Rp 674,6 jt tidak terhitung sampai itu ketahuan.
-- Kelompok 'tanpa_faktur' karena itu adalah daftar periksa, bukan daftar tuduhan.
