    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="right" className="w-full sm:max-w-md">
        <SheetHeader>
          ...
          <SheetDescription>Geo divalidasi otomatis terhadap bbox Indonesia.</SheetDescription>
        </SheetHeader>
          ...
          <div className="flex flex-1 flex-col gap-4 overflow-y-auto px-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="grid gap-1.5">
                ...
                <Input id="v-lat" inputMode="decimal" value={f.lat} onChange={(e) => setF((p) => ({ ...p, lat: e.target.value }))} placeholder="-6.2" />
              </div>
              <div className="grid gap-1.5">
                <Label htmlFor="v-lon">Longitude</Label>
                <Input id="v-lon" inputMode="decimal" value={f.lon} onChange={(e) => setF((p) => ({ ...p, lon: e.target.value }))} placeholder="106.816" />
              </div>
            </div>
            <div className="grid gap-1.5">
